...
# AI-DLC Workflow Active — sf-case-intent-processor
...
- **Manifest**: `.aidlc/workflow/sf-case-intent-processor/aidlc-manifest.yaml`
- **Specs**: `.aidlc/specs/sf-case-intent-processor/`
- **Workflow**: `.aidlc/workflow/sf-case-intent-processor/`
...
1. Read `.aidlc/workflow/sf-case-intent-processor/aidlc-manifest.yaml` for current state
...
- **Feature**: sf-case-intent-processor
- **Language**: English
- **Specs**: `.aidlc/specs/sf-case-intent-processor/`
